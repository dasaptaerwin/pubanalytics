...
![dilan1990](got_any_papers.png){width=800px}
...
![treemap](filter1_intitle_type.jpg){width=700px}
...
![byyear](dim_intitle_byyear.png){width=500px}

results: top 10 field of research
=====

![by field](dim_intitle_field.png){width=500px}

results: top 10 authors
=====

![by researcher](dim_intitle_researcher.png){width=500px}

results: sources
=====

![by sources](dim_intitle_source.png){width=500px}

results: sum of citations
=====

![by citations](dim_intitle_bycitation.png){width=500px}

results: cited/not cited
=====

![by cited/not cited](dim_intitle_cited.png){width=500px}

results: highest citation
=====
...
![by cited/not cited](dim_intitle_avgcited.png){width=500px}
...
![RCR](dim_intitle_rcr.png){width=500px}
...
![FCR](dim_intitle_fcr.png){width=500px}
...
![source](dim_OA_source.png){width=500px}


researcher 
=====

![researcher](dim_OA_researcher.png){width=500px}

field 
=====

![field](dim_OA_field.png){width=500px}


highest citation{width=600px}
=====
...
![IR role in research](IR_research.jpg){width=500px}
